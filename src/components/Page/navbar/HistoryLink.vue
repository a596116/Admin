<template>
  <section
    ...
    <ul ref="historyRef" class="grid justify-start grid-flow-col gap-3 rounded-lg">
      <li
        v-for="link in menuStore.historyMenus"
        :key="link.title"
        class="box-border flex items-center text-sm border rounded-lg shadow-sm group whitespace-nowrap bg-hd-bg-1 hover:bg-hd-primary"
        :class="{
        ...
        <svg-icon
          name="close"
          class="w-4 h-4 mx-1 duration-150 cursor-pointer hover:text-hd-white-50"
