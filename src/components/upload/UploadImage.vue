<template>
  <div class="w-full">
    <ul ref="uploadRef" class="flex flex-wrap w-full h-full gap-2 draggable-upload">
      <li
        ...
        <article class="flex flex-col justify-between w-full h-full">
          <div class="flex justify-center w-full h-full">
            <el-image :src="item" fit="contain" class="w-full h-full"></el-image>
          </div>
        </article>
        <article
          class="absolute top-0 flex flex-col w-full h-full duration-300 opacity-0 hover:opacity-100">
          <div class="flex flex-col items-center w-full h-full delay-75 bg-gray-100/70">
